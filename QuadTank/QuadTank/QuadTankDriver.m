...
subplot(3,2,1)
hold on
p = stairs(PrimalDual_t/T,PrimalDual_x(:,3),'b')
p.LineWidth = 1
...
subplot(3,2,2)
hold on
p = stairs(PrimalDual_t/T,PrimalDual_x(:,4),'b')
p.LineWidth = 1
...
subplot(3,2,3)
hold on
p = stairs(PrimalDual_t/T,PrimalDual_x(:,1),'b')
p.LineWidth = 1
...
subplot(3,2,4)
hold on
p = stairs(PrimalDual_t/T,PrimalDual_x(:,2),'b')
p.LineWidth = 1
...
subplot(3,2,5)
hold on
p = stairs(PrimalDual_t/T,PrimalDual_x(:,5),'b')
p.LineWidth = 1
%title('u1')
ylabel('{u_\xi}_1 [V]')
xlabel('t [s]')
...
subplot(3,2,6)
hold on
p = stairs(PrimalDual_t/T,PrimalDual_x(:,6),'b')
p.LineWidth = 1
grid
%title('u2')
ylabel('{u_\xi}_2 [V]')
...
subplot(3,2,1)
hold on
p = stairs(QuadProg_t/T,QuadProg_x(:,3),'b')
p.LineWidth = 1
%stairs(tt,kc*x_est(3,:),'--r')
ylabel('{x_\xi}_3 [cm]')
%title('x3')
...
subplot(3,2,2)
hold on
p = stairs(QuadProg_t/T,QuadProg_x(:,4),'b')
p.LineWidth = 1
%stairs(tt,kc*x_est(4,:),'--r')
ylabel('{x_\xi}_4 [cm]')
%title('x4')
...
subplot(3,2,3)
hold on
p = stairs(QuadProg_t/T,QuadProg_x(:,1),'b')
p.LineWidth = 1
stairs(tt,kc*x_est(1,:),'--r')
...
subplot(3,2,4)
hold on
p = stairs(QuadProg_t/T,QuadProg_x(:,2),'b')
p.LineWidth = 1
...
subplot(3,2,5)
hold on
p = stairs(QuadProg_t/T,QuadProg_x(:,5),'b')
p.LineWidth = 1
%title('u1')
ylabel('{u_\xi}_1 [V]')
xlabel('t [s]')
...
subplot(3,2,6)
hold on
p = stairs(QuadProg_t/T,QuadProg_x(:,6),'b')
p.LineWidth = 1
grid
%title('u2')
ylabel('{u_\xi}_2 [V]')
